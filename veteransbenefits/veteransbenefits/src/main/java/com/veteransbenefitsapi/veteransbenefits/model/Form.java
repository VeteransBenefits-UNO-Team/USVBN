...
public class Form {
    ...
    private String name;
    /**
     * The path to the form in our application from content root (e.g.
    ...
    /**
     *
     * @param userData The compilation of all the users responses to the
     *                 questionnaire
     * @return True if no requirements or if user responses meet document's
     *         requirements
     */
     ...
     * @return Form object of the newly created form, new forms should be placed in
     *         the resources/forms directory
     */
    private Form createForm(String name) {
        Form form = new Form();
        form.setName(name);
        form.setPath("../../forms/" + name);
        return form;
    }

    /**
     *
     * @return Hardcoded form object of this specific form, with the specific
